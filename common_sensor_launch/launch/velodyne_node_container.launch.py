...
def launch_setup(context, *args, **kwargs):
    ...
    cropbox_parameters["min_x"] = vehicle_info["min_longitudinal_offset"] - LaunchConfiguration(
        "vehicle_crop_margin"
    )
    cropbox_parameters["max_x"] = vehicle_info["max_longitudinal_offset"] + LaunchConfiguration(
        "vehicle_crop_margin"
    )
    cropbox_parameters["min_y"] = vehicle_info["min_lateral_offset"] - LaunchConfiguration(
        "vehicle_crop_margin"
    )
    cropbox_parameters["max_y"] = vehicle_info["max_lateral_offset"] + LaunchConfiguration(
        "vehicle_crop_margin"
    )
    cropbox_parameters["min_z"] = vehicle_info["min_height_offset"] - LaunchConfiguration(
        "vehicle_crop_margin"
    )
    cropbox_parameters["max_z"] = vehicle_info["max_height_offset"] + LaunchConfiguration(
        "vehicle_crop_margin"
    )
    ...
    cropbox_parameters["min_x"] = mirror_info["min_longitudinal_offset"] - LaunchConfiguration(
        "vehicle_crop_margin"
    )
    cropbox_parameters["max_x"] = mirror_info["max_longitudinal_offset"] + LaunchConfiguration(
        "vehicle_crop_margin"
    )
    cropbox_parameters["min_y"] = mirror_info["min_lateral_offset"] - LaunchConfiguration(
        "vehicle_crop_margin"
    )
    cropbox_parameters["max_y"] = mirror_info["max_lateral_offset"] + LaunchConfiguration(
        "vehicle_crop_margin"
    )
    cropbox_parameters["min_z"] = mirror_info["min_height_offset"] - LaunchConfiguration(
        "vehicle_crop_margin"
    )
    cropbox_parameters["max_z"] = mirror_info["max_height_offset"] + LaunchConfiguration(
        "vehicle_crop_margin"
    )
...
def generate_launch_description():
    ...
    add_launch_arg("vehicle_crop_margin", description="margin when cropping ego vehicle")
