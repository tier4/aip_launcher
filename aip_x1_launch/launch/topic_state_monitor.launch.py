...
def generate_launch_description():
    ...
    topic_state_monitor_rough_no_ground = ComposableNode(
        ...
        parameters=[
            {
                "topic": "/perception/object_segmentation/ground_segmentation/no_ground/pointcloud",
                "topic_type": "sensor_msgs/msg/PointCloud2",
                "best_effort": True,
                "diag_name": "sensing_topic_status",
                "warn_rate": 5.0,
    ...
    topic_state_monitor_short_height_no_ground = ComposableNode(
        ...
        parameters=[
            {
                "topic": "/perception/object_segmentation/ground_segmentation/short_height/no_ground/pointcloud",
                "topic_type": "sensor_msgs/msg/PointCloud2",
                "best_effort": True,
                "diag_name": "sensing_topic_status",
                "warn_rate": 5.0,
